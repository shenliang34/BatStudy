package com.gamehero.sxd2.pro {
	...
	public final class MSG_INSTANCE_ENTER_REQ extends com.netease.protobuf.Message {
		/**
		 *  @private
		 */
		public static const INSTANCE_ID:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("com.gamehero.sxd2.pro.MSG_INSTANCE_ENTER_REQ.instance_id", "instanceId", (1 << 3) | com.netease.protobuf.WireType.VARINT);
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					if (instance_id$count != 0) {
						throw new flash.errors.IOError('Bad data format: MSG_INSTANCE_ENTER_REQ.instanceId cannot be set twice.');
					}
					++instance_id$count;

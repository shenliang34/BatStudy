package com.gamehero.sxd2.pro {
	...
	public final class MSG_MAIL_INFO_REQ extends com.netease.protobuf.Message {
		/**
		 *  @private
		 */
		public static const CUR_PAGE:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("com.gamehero.sxd2.pro.MSG_MAIL_INFO_REQ.cur_page", "curPage", (1 << 3) | com.netease.protobuf.WireType.VARINT);
		...
		override com.netease.protobuf.used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					if (cur_page$count != 0) {
						throw new flash.errors.IOError('Bad data format: MSG_MAIL_INFO_REQ.curPage cannot be set twice.');
					}
					++cur_page$count;

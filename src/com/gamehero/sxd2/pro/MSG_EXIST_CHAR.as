package com.gamehero.sxd2.pro {
	...
	public final class MSG_EXIST_CHAR extends com.netease.protobuf.Message {
		/**
		 *  @private
		 */
		public static const CHARS:RepeatedFieldDescriptor$TYPE_MESSAGE = new RepeatedFieldDescriptor$TYPE_MESSAGE("com.gamehero.sxd2.pro.MSG_EXIST_CHAR.chars", "chars", (1 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, function():Class { return com.gamehero.sxd2.pro.CHAR_ID_INFO; });
		 ...
		 *  @private
		 */
		public static const SERVERVER:FieldDescriptor$TYPE_STRING = new FieldDescriptor$TYPE_STRING("com.gamehero.sxd2.pro.MSG_EXIST_CHAR.serverVer", "serverVer", (2 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED);
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 2:
					if (serverVer$count != 0) {
						throw new flash.errors.IOError('Bad data format: MSG_EXIST_CHAR.serverVer cannot be set twice.');
					}
					++serverVer$count;

package com.gamehero.sxd2.pro {
	...
	public final class MSG_SKILL_UPGRADE_REQ extends com.netease.protobuf.Message {
		/**
		 *  @private
		 */
		public static const GROUPID:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("com.gamehero.sxd2.pro.MSG_SKILL_UPGRADE_REQ.groupId", "groupId", (1 << 3) | com.netease.protobuf.WireType.VARINT);
		...
		override com.netease.protobuf.used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					if (groupId$count != 0) {
						throw new flash.errors.IOError('Bad data format: MSG_SKILL_UPGRADE_REQ.groupId cannot be set twice.');
					}
					++groupId$count;

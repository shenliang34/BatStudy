package com.gamehero.sxd2.pro {
	...
	public final class MSG_BATTLE_CREATE_ACK extends com.netease.protobuf.Message {
		/**
		 *  @private
		 */
		public static const DETAIL:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("com.gamehero.sxd2.pro.MSG_BATTLE_CREATE_ACK.detail", "detail", (1 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, function():Class { return com.gamehero.sxd2.pro.PRO_BattleDetail; });
		...
		override com.netease.protobuf.used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					if (detail$count != 0) {
						throw new flash.errors.IOError('Bad data format: MSG_BATTLE_CREATE_ACK.detail cannot be set twice.');
					}
					++detail$count;

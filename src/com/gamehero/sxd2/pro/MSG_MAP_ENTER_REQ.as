package com.gamehero.sxd2.pro {
	...
	public final class MSG_MAP_ENTER_REQ extends com.netease.protobuf.Message {
		/**
		 *  @private
		 */
		public static const MAP:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("com.gamehero.sxd2.pro.MSG_MAP_ENTER_REQ.map", "map", (1 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, function():Class { return com.gamehero.sxd2.pro.PRO_Map; });
		...
		override com.netease.protobuf.used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					if (map$count != 0) {
						throw new flash.errors.IOError('Bad data format: MSG_MAP_ENTER_REQ.map cannot be set twice.');
					}
					++map$count;

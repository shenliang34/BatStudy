package com.gamehero.sxd2.pro {
	...
	public final class MSGID_BATTLE_CD_TIME_ACK extends com.netease.protobuf.Message {
		/**
		 *  @private
		 */
		public static const BATTLE_ID:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("com.gamehero.sxd2.pro.MSGID_BATTLE_CD_TIME_ACK.battle_id", "battleId", (1 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const PLAYER_ID:FieldDescriptor$TYPE_UINT64 = new FieldDescriptor$TYPE_UINT64("com.gamehero.sxd2.pro.MSGID_BATTLE_CD_TIME_ACK.player_id", "playerId", (2 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const TIME:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("com.gamehero.sxd2.pro.MSGID_BATTLE_CD_TIME_ACK.time", "time", (3 << 3) | com.netease.protobuf.WireType.VARINT);
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					if (battle_id$count != 0) {
						throw new flash.errors.IOError('Bad data format: MSGID_BATTLE_CD_TIME_ACK.battleId cannot be set twice.');
					}
					++battle_id$count;
				...
				case 2:
					if (player_id$count != 0) {
						throw new flash.errors.IOError('Bad data format: MSGID_BATTLE_CD_TIME_ACK.playerId cannot be set twice.');
					}
					++player_id$count;
				...
				case 3:
					if (time$count != 0) {
						throw new flash.errors.IOError('Bad data format: MSGID_BATTLE_CD_TIME_ACK.time cannot be set twice.');
					}
					++time$count;

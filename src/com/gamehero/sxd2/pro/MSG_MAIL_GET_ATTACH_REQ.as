package com.gamehero.sxd2.pro {
	...
	public final class MSG_MAIL_GET_ATTACH_REQ extends com.netease.protobuf.Message {
		/**
		 *  @private
		 */
		public static const MAIL_ID:FieldDescriptor$TYPE_UINT64 = new FieldDescriptor$TYPE_UINT64("com.gamehero.sxd2.pro.MSG_MAIL_GET_ATTACH_REQ.mail_id", "mailId", (1 << 3) | com.netease.protobuf.WireType.VARINT);
		...
		override com.netease.protobuf.used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					if (mail_id$count != 0) {
						throw new flash.errors.IOError('Bad data format: MSG_MAIL_GET_ATTACH_REQ.mailId cannot be set twice.');
					}
					++mail_id$count;

package com.gamehero.sxd2.guide.script
{
	 ...
	 * @create 2014-01-15
	 **/
	public class Guide_10001 extends Guide
	{
		...
		override public function playGuide(info:GuideVO, callBack:Function = null , param:Object = null):void
		{
			...
			if(battleView)
			{
				skillBtn = battleView.getSkIcon(0);
				this.popupClickGuide(skillBtn, true, Lang.instance.trans("AS_1400"), Direct_Down , finish);

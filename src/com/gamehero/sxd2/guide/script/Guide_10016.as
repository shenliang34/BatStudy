package com.gamehero.sxd2.guide.script
{
	...
	/**
	 * 第二场战斗引导,单位3再次触发剧情并变身
	 * @author xuwenyi
	 * @create 2014-10-10
	 **/
	public class Guide_10016 extends Guide
	{
		...
		private function next2():void
		{
			...
			function burst():void
			{
				var url:String = GameConfig.BATTLE_NEW_PLAYER_URL + "trans_shitake.swf";
			...
			{
				var modelURL:String = "monster_bianshenshitake01_b";
		...
		{
			var seURL:String = GameConfig.BATTLE_NEW_PLAYER_URL + "skill_shitake_se.swf";
			BattleEfCanvas.instance.playSwf(seURL,"EFFECT",player.x,player.y,1);
			
			var uaURL:String = GameConfig.BATTLE_NEW_PLAYER_URL + "skill_shitake_ua.swf";
			// 定位
			var grid2:BattleGrid = BattleDataCenter.instance.grid2;
			var pos:Vector2D = grid2.CAMP_POS_S[10];// 11号位
			pos = pos.add(grid2.offset);
			BattleEfCanvas.instance.playSwf(uaURL,"EFFECT",pos.x,pos.y,1);
